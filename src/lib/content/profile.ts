...
export const profile: ProfileContent = {
  ...
  classTag: "FULL-STACK // FRONTEND ARCHITECT",
  ...
  detailedBio:
    "Frontend developer crafting fast, clean, and scalable web interfaces with React, Next.js, Tailwind CSS, and TypeScript. I focus on responsive layouts, accessible interaction patterns, polished motion, and production-ready frontend architecture that can grow into full-stack systems.",
